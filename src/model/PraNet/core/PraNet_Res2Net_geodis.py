...
# from .Res2Net_v2 import res2net50_v2, res2net101_v2

backbone_map = {
    'resnet50': res2net50_v1b_26w_4s,
    'resnet101': res2net101_v1b_26w_4s,
    # 'resnet50v2': res2net50_v2,
    # 'resnet101v2': res2net101_v2,
}
...
class RFB_modified(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.conv_cat = BasicConv2d(4*out_channel, out_channel, 3, padding=1) # cat 4 tensors from branch_{0..3}
