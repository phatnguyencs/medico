...
class COCOEvaluator(DatasetEvaluator):
    ...
    def process(self, inputs, outputs):
        ...
        # self._loss += sum(loss for loss in outputs.values())
    ...
    def evaluate(self):
        ...
        # self._results['total_loss'] = self._loss
    ...
    def _eval_predictions(self, tasks, predictions):
        ...
        for task in sorted(tasks):
            ...
            if self._output_dir:
                file_path = os.path.join(self._output_dir, f"{task}_results.json")
                self._logger.info("Saving evaluation prediction results to {}".format(file_path))
                with PathManager.open(file_path, "w") as f:
